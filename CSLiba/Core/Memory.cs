...
namespace CSLiba.Core
{
    ...
    {
        public static Process cProcess;
        public static Process m_Process;
        public static IntPtr m_pProcessHandle;
        public static bool gameFound = true;

        public static int clientBase { get; private set; }
        internal static int clientSize { get; private set; }
        public static int engineBase { get; private set; }
        internal static int engineSize { get; private set; }

        internal static int m_iNumberOfBytesRead = 0;
        internal static int m_iNumberOfBytesWritten = 0;
        ...
        public static bool Initialize()
        {
            ...
            DialogResult result = MessageBox.Show("Game not found. Ignore and run chat?", "Exarp", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        public static bool GetHandle(string ProcessName)
        {
            ...
            m_pProcessHandle = OpenProcess(0x0008 | 0x0010 | 0x0020 | 0x00100000, false, m_Process.Id);
            return true;
        }
